...
module API =
    ...
    val MethodMockAndCall : state -> IMethod -> term option -> term list -> state * term option
    val ExternMockAndCall : state -> IMethod -> term option -> term list -> state * term option
